...
def gen_prompt(train_df, subject, k=-1):
    prompt = refuse_prompt+"The following are multiple choice questions (with answers) about {}.\n\n".format(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_dir", "-s", type=str, default="refuse-logits-results")
